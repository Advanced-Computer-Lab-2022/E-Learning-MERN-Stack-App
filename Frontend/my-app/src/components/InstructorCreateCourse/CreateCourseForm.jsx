        ...
        <form className="flex flex-col pt-3 md:pt-8">
            ...
            <div className="flex flex-col pt-4 mb-5">
                <div className="flex relative ">
                    ...
                    <select name="role" className="flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-800 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" onChange={e => (e)} >
